...
$dbuser = "ji64";//your ucid since we follow this pattern
$dbpass = "AI7pW/YM63ZPTVXc";//database password generated or chosen per respective steps
$dbdatabase = "ji64";//your ucid since we follow this pattern
?>